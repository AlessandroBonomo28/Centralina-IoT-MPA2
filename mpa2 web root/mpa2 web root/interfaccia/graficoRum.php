<html>
<head>
	<title>Grafico di rumorosità</title>
	<meta charset="utf-8">
...
<ul class="sidenav sidenav-fixed">
    ...
    <li class="sidenav-select active"><a href=""><i class="material-icons icons-white">volume_up</i>Rumore</a></li> 
</ul>
...
<h1><a>Grafico di rumorosità</a></h1>
<br>
    ...
    <div class="col-sm">
      <select id="SelSensore" name="SelSensore" 
		onchange="azioneSelSensore()" class="form-control form-control-lg">
		 <option value="" selected disabled>Seleziona sensore di rumorosità</option>
	  </select>
    </div>
</div>
...
function azioneSelCentralina()
{
	...
	$.ajax({
		 data: data,
		 type: "post",
		 url: "queryAjax/queryGraficoRum/sensoriRumDiUnaCentralina.php",
...
function azioneSelSensore()
{
	...
	$.ajax({
		 data: data,
		 type: "post",
		 url: "queryAjax/queryGraficoRum/anniLettureSensoriRum.php",
		 success: function(data){
			  //alert("Esito: " + data);
...
function azioneSelAnno()
{
	...
	$.ajax({
		 data: data,
		 type: "post",
		 url: "queryAjax/queryGraficoRum/mesiLettureSensoriRum.php",
		 success: function(data){
			  //alert("Esito: " + data);
...
function azioneSelMese()
{
	...
	$.ajax({
		 data: data,
		 type: "post",
		 url: "queryAjax/queryGraficoRum/giorniLettureSensoriRum.php",
		 success: function(data){
			  //alert("Esito: " + data);
...
function azioneSelGiorno()
{
	...
	$.ajax({
		 data: data,
		 type: "post",
		 url: "queryAjax/queryGraficoRum/graficoGiornalieroRum.php",
		 success: function(data){
			  //alert("Esito: " + data);
			  ...
			  var rumore = [];
			  for(var i=0;i<datiGrafico.length;i++)rumore[i] = datiGrafico[i]["rumore"];
			  var legenda = "Rumore in decibel";
			  var bgRgba = "rgba(254, 241, 96, 1)";
			  var borderRgba= "rgba(247, 202, 24, 1)";
			  ...
			  var istanzaGrafico = creaGrafico("cnvsGrafico",rumore,ore,tipoGrafico,legenda,bgRgba,borderRgba);
